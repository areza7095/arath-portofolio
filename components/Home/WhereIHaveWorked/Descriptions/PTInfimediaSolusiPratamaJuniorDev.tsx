...
export default function PTInfimediaSolusiPratamaJuniorDev() {
  const tasks = [
    {
      ...
      <div className="flex flex-col space-y-5 max-w-xl px-4 md:px-0">
        <div className="flex flex-col spacey-y-2">
          ...
          <span className="text-gray-100 sm:text-lg text-sm font-Arimo tracking-wide">
            Junior Developer <span className="text-AAsecondary">@ Hybrid</span>
          </span>
          {/* Date */}
          <span className="font-mono text-xs text-gray-500">July 2022 - June 2023</span>
          <span
